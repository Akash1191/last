  ...
  return (
    <div className="container mt-5">
      ...
      <div className="mb-3">
        ...
        <button className="btn btn-warning mt-2" onClick={handleAddToHub}>
          Add to Hub
        </button>
      </div>
      <div className="mb-3">
        ...
        />
        <button className="btn btn-info mt-2" onClick={handleGetFarmerProducts}>
          Get Farmer Products
        </button>
      </div>
      ...
      <ul>
        {farmerProducts[0] &&
          farmerProducts[0].map((name, index) => (
            <li key={index}>
              {name}: {farmerProducts[1][index]} units
            </li>
          ))}
      </ul>
    </div>
